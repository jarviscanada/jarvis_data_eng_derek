...
public interface Service {
   ...
   */
  Tweet postTweet(Tweet tweet) throws IOException, URISyntaxException, Exception;
   ...
   */
  Tweet showTweet(String id, String[] fields) throws URISyntaxException, OAuthExpectationFailedException, OAuthCommunicationException, OAuthMessageSignerException, IOException;
