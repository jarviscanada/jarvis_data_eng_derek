...
public class TraderAccountController {
    ...
    @ApiOperation(value = "Create a trader and an account.", notes = "TraderId and AccountId are auto generated by " +
            "the database, and they should be identical. Assume each trader has exact one account.")
    @ResponseStatus(HttpStatus.CREATED)
    @ResponseBody
    @PostMapping(
            path = "/firstname/{firstname}/lastname/{lastname}/dpb/{dob}/country/{country}/email/{email}",
    ...
    @ApiOperation(value = "Delete a trader", notes = "Delete a trader IF its account amount is 0 and no open posititon." +
    ...
    @ApiOperation(value = "Deposit a fund", notes = "Deposit a fund to the account that associates with the given" +
            "traderId. Deposit a")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Withdraw a fund", notes = "Withdraw a fund from the account that associates with the " +
            "given traderId, withdraw")
    @ApiResponses(value = {
            @ApiResponse(code = 404, message = "traderId is not found"),
